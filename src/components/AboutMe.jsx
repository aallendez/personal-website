    ...
    return(
      <div id="aboutMe" className="pt-32 w-full min-h-screen flex flex-col-reverse sm:flex-col-reverse md:flex-col-reverse xs:flex-col-reverse text-center gap-20 items-start md:px-4" >
        ...
        <div className="">
            ...
            <p className="text-3xl mb-2 font-bold">Hi! I'm Juan.</p><br />I'm a Full Stack Developer, AI and Business enthusiast . I am also a Computer Science & Artificial Intelligence student in Spain. 
            <br />I've always considered myself to be curious. When I was 13 years old, I started shooting and editing videos and eventually got pretty good at it which provided me with several professional opportunities. I also play the guitar, and got a lot into music production. However, since 2023 I have been deeply involved in <strong className="hover:opacity-80 transition-opacity">software development</strong> and <strong className="hover:opacity-80 transition-opacity">artificial intelligence</strong>.
